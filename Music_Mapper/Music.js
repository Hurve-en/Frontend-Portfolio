...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderHistory() {
    ...
    history.slice(-10).forEach(entry => {
      ...
      const btn = document.querySelector(`[data-mood="${entry.mood}"]`);
      span.textContent = btn ? btn.textContent.split(" ")[0] : "•";

      span.addEventListener("click", () => setMood(entry.mood));
